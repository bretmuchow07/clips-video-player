...
class FloatingLines {
    constructor(containerId, options = {}) {
        ...
        if (!this.container) {
            console.error(`FloatingLines: Container element with id '${containerId}' not found.`);
            return;
        }
    ...
    init() {
        ...
        this.renderer = new THREE.WebGLRenderer({ antialias: true, alpha: true }); // Alpha true for background transparency if needed
    ...
    initUniforms() {
        const {
            ...
            topWavePosition, middleWavePosition, bottomWavePosition,
            animationSpeed, interactive, bendRadius, bendStrength, parallax, parallaxStrength, linesGradient
        } = this.options;
    ...
    initEvents() {
        ...
        if (this.options.interactive) {
            // Use window or document.body for global paranoia/mouse tracking if intended to be full screen
            // but the original code attached to renderer.domElement.
            // Since it's a background, maybe window is better? 
            // But the original code was: renderer.domElement.addEventListener...
            // I'll stick to domElement (canvas) but make sure canvas covers specific area.
        ...
        this.resizeHandler = handleResize; // Keep reference to remove if needed (not implementing destroy atm)
    }
